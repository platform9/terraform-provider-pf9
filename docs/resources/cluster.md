...
- `api_server_storage_backend` (String)
- `app_catalog_enabled` (Boolean)
...
- `can_minor_upgrade` (Boolean)
- `can_patch_upgrade` (Boolean)
- `can_upgrade` (Boolean) Can upgrade
...
- `num_masters` (Number)
- `num_max_workers` (Number)
- `num_min_workers` (Number)
- `num_workers` (Number)
- `patch_upgrade_role_version` (String)
- `project_id` (String)
