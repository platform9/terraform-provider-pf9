	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"filter": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Description:         "Filter to apply to the list of nodes",
				MarkdownDescription: "Filter to apply to the list of nodes",
				DeprecationMessage:  "This field is deprecated and will be removed in a future release. Use the 'filters' field instead.",
			},
			...
			"node_ids": schema.ListAttribute{
				ElementType:         types.StringType,
				Computed:            true,
				Description:         "A list of node IDs for nodes that match all the specified filters.",
				MarkdownDescription: "A list of node IDs for nodes that match all the specified filters.",
			},
			"nodes": schema.ListNestedAttribute{
				...
				DeprecationMessage:  "This field is deprecated and will be removed in a future release. Use the 'node_ids' field instead.",
			},
		},
	}
}
