module github.com/platform9/terraform-provider-pf9
...
require (
	...
	github.com/platform9/pf9-sdk-go v0.0.0
...
// If user compiling does not access to these repo then uncomment this
